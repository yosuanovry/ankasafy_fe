      ...
      <div className="flex flex-col justify-center mx-16 sm:mx-20 md:mx-24 lg:mx-28 w-2/6">
        ...
        <div className="flex flex-col my-6">
          ...
          <form>
            ...
            <div className="mt-10">
              <input className="p-2 ps-1 my-2 lg:my-6 text-xs block w-full px-0.5 border-0 border-b-2 border-purple-200 focus:ring-0 focus:border-yellow-400 sm:text-base md:text-lg" type="password" placeholder="OTP" />
            </div>
            ...
            <span className="flex justify-center items-center mt-10 rounded-lg text-sm sm:text-base md:text-lg py-1 md:py-4 font-semibold" style={{ backgroundColor: "#2395FF", color: "white" }}>
              <button type="submit" style={{width:455}}>Verify</button>
            </span>
          </form>
        </div>
      </div>
